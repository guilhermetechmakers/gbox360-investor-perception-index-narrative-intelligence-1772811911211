...
interface ErrorLayoutContainerProps {
...
/**
 * Page scaffold for error pages with header and centered content.
 * Preserves consistent chrome with 404 and other error pages.
 */
export function ErrorLayoutContainer({ children, className }: ErrorLayoutContainerProps) {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main
        className={cn(
          'flex-1 flex flex-col items-center justify-center px-4 py-12 md:py-16',
          className
        )}
      >
        {children}
